      ...
      <div className="header-container">
          ...
          <Link to="/" className="brand-link">
            <div className="brand-icon">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12 16C14.21 16 16 14.21 16 12C16 9.79 14.21 8 12 8C9.79 8 8 9.79 8 12C8 14.21 9.79 16 12 16Z" fill="currentColor" opacity="0.7"/>
              </svg>
            </div>
            <div className="brand-text">
              <h1 className="brand-title">HealthHub</h1>
              <span className="brand-subtitle">개인 건강 플랫폼</span>
            </div>
          </Link>
        </div>
        ...
        <div className="header-nav">
          ...
          <div className="quick-actions">
            <button className="quick-action-btn" title="알림">
            ...
            <button className="quick-action-btn" title="빠른 기록">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
